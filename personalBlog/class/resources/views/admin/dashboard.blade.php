...
@section('breadcrumbs')
    <a href="{{route('adminDashboard')}}" style="color: #999">Dashboard</a>
@endsection
                ...
                <div class="row">
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            <h5 class="desc" style="color: #0b93d5">Out of {{$posts->count()}} posts, you posted {{Auth::user()->posts->count()>0?Auth::user()->posts->count():"none"}}</h5>
                            <div class="icon">
                    ...
                    <div class="col-md-6 col-lg-3">
                        <div class="statistic__item">
                            <h5 class="desc" style="color: #0b93d5">Out of {{$comments->count()}} comments, you made {{Auth::user()->comments->count()>0?Auth::user()->comments->count():"none"}}</h5>
                            <div class="icon">
