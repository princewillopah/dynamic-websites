                ...
                <div class="col-md-12 ">
                    <div class="contents">
                        <div class="contents-message">
                            <h1 class="wow fadeInUp" data-wow-duration="2s">Pastor Festus Adu</h1>
                            ...
                            <span  class="wow fadeInUp float-right navs" data-wow-delay="2s" data-wow-duration="3s">
                                      <a  href="{{route('homepage')}}">Home</a> ><a  href="{{route('leadership')}}"> About Us - Leadership </a> > Pastor Festus Adu </span></div>
                    </div>
                </div>
            </div>
        </div><!-- /.row -->
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="leadership-pics">
                        <img src="{{asset('img/about/leaders/Pastor_Adu_main.jpg')}}" class="img-fluid mx-auto d-block" alt="">
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="leadership-info">
                        <div class="leadership-info-head">
                            <h3>Pastor Festus Adu</h3>
                            <span>Decatur Church</span>
                        </div>
