...
@section('content')
    ...
    <section id="children-intro">
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="contents">
                        <div class="contents-message">
                            <h1 class="wow fadeInUp" data-wow-duration="2s">Children</h1>
                            <div class="wow fadeInUp" data-wow-delay="1s" data-wow-duration="3s">
                             <span  class="wow fadeInUp navs" data-wow-delay="2s" data-wow-duration="3s">
                                      <a  href="{{route('homepage')}}">Home  </a> > Ministries - Children</span></div>
                        </div>
                    </div>
                </div>
            </div><!-- /.row -->
                    ...
                    <div class="info">
                        <div class="row">
                            <div class="col-md-3">
                                <div class="menu">
                                    <nav class="nav flex-column">
                                        <a class="nav-link active" href="{{route('children')}}">Children Ministry</a>
                            ...
                            <div class="col-md-9">
                                <div class="main">
                                    <div class="main-pic">
                                        <img src="{{asset('img/ministry/children/img_1.jpg')}}"  class="img-fluid" alt="">
                                    </div>
                                    <div class="main-writeup">
                                        <h3>Guide The Children</h3>
    ...
    <section id="ministry-teacher">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1> teachers for children ministry</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <span>Head of Children Ministry</span>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{asset('img/ministry/children/person_1.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Maria F. Johnson</h5>
                            <span>Child Dedication Officer</span>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                        <div class="socials">
                            <nav class="nav justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{asset('img/ministry/children/person_4.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Ammy Lee</h5>
                            <span>Children Trainer</span>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                        <div class="socials">
                            <nav class="nav justify-content-center">
            ...
            <div class="row">
                <div class="col-md-12">
                    <div class="recent-sermon-header">
                        <h3>Children Ministry Sermons</h3>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="sermon">
