...
@section('content')
    ...
    <section id="men-intro">
        <div class="container">
            <div class="row">
                <div class="col-md-12 ">
                    <div class="contents">
                        <div class="contents-message">
                            <h1 class="wow fadeInUp" data-wow-duration="2s">Men</h1>
                            <div class="wow fadeInUp" data-wow-delay="1s" data-wow-duration="3s">
                             <span  class="wow fadeInUp navs" data-wow-delay="2s" data-wow-duration="3s">
                                      <a  href="{{route('homepage')}}">Home  </a> > Ministries - Men</span></div>
                        </div>
                    </div>
                </div>
            </div><!-- /.row -->
                            ...
                            <div class="col-md-3">
                                <div class="menu">
                                    <nav class="nav flex-column">
                                        ...
                                        <a class="nav-link" href="{{route('men')}}">Women Ministry</a>
                                        <a class="nav-link active" href="{{route('women')}}">Men Ministry</a>
                                    </nav>
                                </div>
                            </div>
                            <div class="col-md-9">
                                <div class="main">
                                    <div class="main-pic">
                                        <img src="{{asset('img/ministry/men/about_2.jpg')}}" class="img-fluid" alt="">
                                    </div>
                                    <div class="main-writeup">
                                        <h3>God's plan for you</h3>
    ...
    <section id="ministry-teacher">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1> Leaders for Men ministry</h1>
                </div>
            </div>
            <div class="row">
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{asset('img/ministry/men/pastor_1.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Greg F. Johnson</h5>
                            <span>Head of Men Ministry</span>
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{asset('img/ministry/children/person_2.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Manu F. Tony</h5>
                            <span>Male Dedication Officer</span>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                        <div class="socials">
                            <nav class="nav justify-content-center">
                ...
                <div class="col-md-4">
                    <div class="card">
                        <img src="{{asset('img/ministry/men/person_3.jpg')}}" class="card-img-top" alt="...">
                        <div class="card-body">
                            <h5 class="card-title">Golder Lee</h5>
                            <span>Men Secretary</span>
                            <p class="card-text">Some quick example text to build on the card title and make up the bulk of the card's content.</p>
                        </div>
                        <div class="socials">
                            <nav class="nav justify-content-center">
